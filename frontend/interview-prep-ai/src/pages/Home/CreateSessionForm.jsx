...
const CreateSessionForm = () => {
    ...
    const handleCreateSession = async (e) => {
        ...
        try {
            // Simulate API call to generate interview questions
    ...
    return <div className="w-[90vw] md:w-[35vw] p-7 flex flex-col justify-center">
        ...
        <p className="text-xs text-slate-700 mt-[5px] mb-3">
            Create a personalized interview prep session to ace your next job interview.
        </p>
        ...
        <form onSubmit={handleCreateSession} className="flex flex-col gap-3">
            ...
            <Input
                ...
                placeholder="Describe your interview prep goals..."
                type="textarea"
            />
